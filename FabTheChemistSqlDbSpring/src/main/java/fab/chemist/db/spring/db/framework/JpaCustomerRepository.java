 ...
 */
package fab.chemist.db.spring.db.framework;
...
import fab.chemist.db.spring.db.repository.impl.Customer;
import fab.chemist.db.spring.db.repository.impl.EmailAddress;
import fab.chemist.db.spring.db.repository.interf.CustomerRepository;
